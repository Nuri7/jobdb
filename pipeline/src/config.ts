...
// tools that identify themselves. Sending USER_AGENT there made discovery fail intermittently
// (some weekly runs found nothing at all, others were fine), so index.commoncrawl.org requests
// must carry this honest one instead. Verified side by side: browser UA 403, this one 200.
